...
const Experience = () => {
  const { t } = useTranslation(); // Usamos el hook t para traducir
  ...
  return (
    <div className="border-b border-violet-950 pb-4">
      ...
      >
        {t("experience.title")} {/* Título de la sección */}
      </motion.h1>

      <div>
        {/* Mapeamos las experiencias */}
        {t("experience.items", { returnObjects: true }).map((experience, index) => {
          return (
